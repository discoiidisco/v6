...
<div class="right text-right show-for-medium-up" id="box-session">
   ...
   {else}
   <a href="{$STORE_URL}/login.html" class="button white small nopad-sides">{$LANG.account.login}</a> <span class="or">{$LANG.common.or}</span> <a href="{$STORE_URL}/register.html" class="button white small nopad-sides">{$LANG.account.register}</a>
   {/if}
</div>
