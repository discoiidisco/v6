   ...
   <form action="{$STORE_URL}/search.html" class="search_form" method="get">
      <div class="row collapse">
         <div class="small-10 large-11 columns">
            <input name="search[keywords]" type="text" class="nomarg" placeholder="{$LANG.search.input_default}" required><small class="right"><a href="{$STORE_URL}/search.html">{$LANG.search.advanced}</a></small>
         </div>
